...
- **[Engagement rules](./engagement-rules.md)** — explicit behavioral conditions the skill must satisfy. Each rule addresses a concrete behavior that would change if the rule were removed.
